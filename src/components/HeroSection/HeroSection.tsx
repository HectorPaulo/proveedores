...
const LandingPage = () => {
    ...
    return (
        <section>
            <div className=" text-gray-300 overflow-hidden md:px-8 flex flex-row items-center justify-center gap-x-10">
                <div className="space-y-15 max-w-xl text-center">
                    ...
                    <div className="flex justify-center items-center gap-x-3 sm:text-sm">
                        <a
                            ...
                            className='flex items-center gap-x-2 text-gray-300 hover:text-gray-100 cursor-pointer border-t-2 border-l-2 border-r-4 border-b-4 border-gray-300 rounded-lg px-4 py-2'
                        >
                            Conócenos
                            <svg
